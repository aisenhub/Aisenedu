...
> This is the UI/UX Pro Max design proposal for Aisenedu. The repository's existing semantic tokens in `apps/web/src/styles/index.css`, local system-font policy, shadcn/ui component source, and explicit product requirements are authoritative. The Google Fonts suggestion below is intentionally not adopted.
...
- **External Fonts:** Not used. Keep local system font stacks for consistent Chinese screen and print output.

**CSS Import:**
```css
/* Do not add remote font imports; use the repository font tokens. */
```
