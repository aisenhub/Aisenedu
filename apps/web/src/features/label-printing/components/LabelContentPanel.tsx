...
function AppearanceColorField({ defaultValue, id, label, onChange, value }: Readonly<{ defaultValue: string; id: string; label: string; onChange: (value: string) => void; value: string }>) {
