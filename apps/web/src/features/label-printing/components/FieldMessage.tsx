  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <button aria-label={label} className="inline-flex size-6 cursor-help items-center justify-center rounded-md text-text-muted hover:bg-surface-muted focus:outline-none focus:ring-4 focus:ring-focus/25" type="button">
